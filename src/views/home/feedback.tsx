  ...
  return (
    <section className="px-5 my-52 md:px-10 lg:px-24 flex justify-center items-center">
      <div className="left-side w-1/2 mr-20">
        ...
        <h1 className="font-bold text-3xl text-dark-blue leading-tight dark:text-white">
          Feedback dos nossos clientes
        </h1>
        <p className="text-dark-gray mt-5 dark:text-light-gray">
          ...
          <CarouselContent className="flex-auto flex">
            <CarouselItem className="flex-none">
              <div className="card w-[450px] h-96 p-10 rounded-lg bg-light-gray bg-opacity-10 flex flex-col items-center justify-center">
                ...
                <div className="text mt-10 text-lg text-center text-dark-gray dark:text-white">
                  “O maior dos critérios para escolha do Qualist foi a
                  usabilidade do sistema, que é muito boa e entrega tudo o que a
                  gente precisa para nosso sistema de gestão.”
                </div>
              </div>
            </CarouselItem>
            <CarouselItem className="flex-none">
