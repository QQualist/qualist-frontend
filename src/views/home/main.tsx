...
const Main = () => {
    ...
    return (
        ...
        <main className='text-center h-[calc(100vh-80px)] m-5 md:m-10 lg:ml-24 lg:text-start p-0 flex justify-center items-center'>
            ...
            <div className="right-side w-0 lg:w-1/2">
                <img className='hidden bottom-[calc(0px-80px)] lg:block lg:w-[42%] 2xl:w-2/5 absolute' src={MainImage} alt="Woman using a Notebook" />
            </div>
        </main>
    )
}
